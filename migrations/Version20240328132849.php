 ...
 */
final class Version20240328132849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE compagne_dons (id INT AUTO_INCREMENT NOT NULL, muni_id INT NOT NULL, date_d DATE NOT NULL, date_f DATE NOT NULL, montant_e DOUBLE PRECISION NOT NULL, descrip VARCHAR(255) NOT NULL, INDEX IDX_E6FA1A24D5CE03AE (muni_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
