...
class SolutionsController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, SessionInterface $session,ReclamationsRepository $reclamrepo): Response
    {
        $solution = new Solutions();
        $reclamations = $reclamrepo->findAll();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $selectedReclamationId = $request->request->get('reclamations')['idRec'];
            $solution->setIdRec($selectedReclamationId);
